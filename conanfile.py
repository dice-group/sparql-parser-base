...
class Recipe(ConanFile):
    ...
    exports_sources = ("CMakeLists.txt", "antlr4cmake/antlr4-generator.cmake.in", "cmake/*", "SparqlLexer.g4", "SparqlParser.g4", "LICENSE-GRAMMAR")
    ...
    def package(self):
        cmake = self._configure_cmake()
        cmake.install()
        copy(self, "LICENSE-GRAMMAR", src=self.source_folder, dst=os.path.join(self.package_folder, "licenses"))
